...
def map_user_plot1(df,year):
    ...
    fig_line_1= px.line(muyg, x= "States", y= ["RegisteredUsers", "AppOpens"],
                        title=f"{year} REGISTERDUSER APPOPENS", width= 1000, height= 500, markers= "True")
    st.plotly_chart(fig_line_1)
...
def map_user_plot3(df, States):
    ...
    with col1:
        fig_map_user_bar_1=px.bar(muyqs, x="RegisteredUsers", y="Districts", orientation="h",
                                title= f"{states.upper()} REGISTERD USER", height= 800, color_discrete_sequence= px.colors.sequential.Rainbow_r)
...
def Top_Transaction_plot_1(df,state):
    ...
    with col2:
        fig_top_tran_bar_2=px.bar(tty, x="Quarter", y="Transaction_count", hover_data= "Pincodes",
                                title= "TRANSACTION COUNT", height= 650, width= 600, color_discrete_sequence= px.colors.sequential.RdBu_r)
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\ELCOT\Desktop\PhonePe\Phonepe-images.jpg"), width= 600)
        
    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\ELCOT\Desktop\PhonePe\Phonepe image 2.jpg"), width= 600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\ELCOT\Desktop\PhonePe\Phonepe-image 3.webp"), width= 600)        
